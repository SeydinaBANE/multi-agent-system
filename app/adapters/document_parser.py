...
Pas de port dédié : aucune implémentation alternative n'est envisagée et
aucune dépendance infra (DB/Qdrant/Redis/LLM) n'a besoin d'être masquée au
domaine — ce module est un simple utilitaire d'I/O appelé directement par
la couche API (app/api/documents.py).
"""
